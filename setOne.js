...
// CODE HERE
const theParameters = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
theParameters(nacho, cheese)
...
greeting("Emma", "V", (fullName) => console.log(`Hello, my full name is ${fullName}.`)
